...
def get_activities(
    ...
    - difficulty: Filter activities by difficulty level ('Beginner', 'Intermediate', 'Advanced', or 'All' for no difficulty specified)
    """
    ...
    for activity in activities_collection.find(query):
        ...
        # Apply difficulty filter after database query since it needs special logic
        if difficulty:
            if difficulty == "All":
                ...
                if activity.get("difficulty") != difficulty:
                    continue
